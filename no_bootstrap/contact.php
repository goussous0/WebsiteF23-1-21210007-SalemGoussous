    ...
    <?php
      ...
      ?>
        <div class="card mt-1"> <!-- mt stands for margin top with 1rem-->
            ...
            <div class="card-bg">
                <img src="/static/img/DALL·E 2022-12-29 12.48.56 - A table full of food that looks like computer parts, digital art .webp" alt='Ceaser salad made from circut componants' id="welcome-img" defer> 
            </div>
