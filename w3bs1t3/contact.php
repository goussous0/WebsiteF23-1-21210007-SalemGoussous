            ...
            <form method="POST" action="contact.php">
                <div class="card" style="background-color:  transparent; box-shadow: 0 0;" id="login_form">
                    ...
                    <div class="field">
                        ...
                        <div class="control">
                            <input class="input" type="text" placeholder="Enter your lastname" required>
                        </div>
                    </div>
                    <div class="field">
                        <label class="label">Email</Label>
                        <div class="control">
                            <input class="input" type="tel" placeholder="Enter your email" required>
                        </div>
                    </div>
                    <div class="field">
                        <label class="label">Phone Number</Label>
                        <div class="control">
                            <input class="input" type="email" placeholder="Enter your phone number" required>
                        </div>
                    </div>
                    <div class="field">
                        <label class="label">Your feedback</Label>
                        <div class="control">
                            <textarea class="input" style="height: 25vh;"> </textarea>
                        </div>
                    </div>
                </div>
                <div class="control">
                    <center>
                        <button name="submit_btn" class="button is-primary" style="margin:1vh;"  onclick="prompt()">Submit</button>
                    </center>
                </div>
            <from>
        </section>
