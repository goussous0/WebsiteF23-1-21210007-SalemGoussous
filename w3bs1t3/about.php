                ...
                <div class="card-image">
                    ...
                    <div class="footer" style="background: transparent;">
                        <div class="footer-row" >
                            <div class="quest">
                                <p class="title is-3 ">What is this website?</p>
                            </div>
                            <div class="ans">                  
                                <p class="title is-6 "> This website is made for fun only and it demonstrates the potintial of the AI.</p>
                            </div>
                        </div>
                        <div class="footer-row" >
                            <div class="quest">
                                <p class="title is-3 ">Who made this website?</p>
                            </div>
                            <div class="ans">                  
                                <p class="title is-6 "> This website is made by a cyber security researcher.</p>
                            </div>
                        </div>
                        <div class="footer-row" >
                            <div class="quest">
                                <p class="title is-3 ">What are these pictures?</p>
                            </div>
                            <div class="ans">                  
                                <p class="title is-6 "> The pictures used in this website are generated by an AI called <p class="title is-6" id="logo">DALL·E</p></p>
                            </div>
                        </div>
                    </div>
                </div>
